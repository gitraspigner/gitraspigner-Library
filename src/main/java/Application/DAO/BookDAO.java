...
public class BookDAO {
    /**
     * DONE: retrieve all books from the Book table.
    ...
    /**
     * DONE: retrieve a book from the Book table, identified by its isbn.
    ...
    /**
     * DONE: insert a book into the Book table.
    ...
    /**
     * DONE: retrieve all books from the Book table with copies_available over zero.
     * You only need to change the sql String and leverage PreparedStatement's setString and setInt methods.
    ...
    public List<Book> getBooksWithBookCountOverZero(){
        ...
        try {
            ...
            //write preparedStatement's setInt method here.
            /**
             * no user input found, this above code can however be modified to include the 
             * use of preparedStatement and setInt to use a primitive 0 int value
             */
            ResultSet rs = preparedStatement.executeQuery();
            while(rs.next()){
                Book book = new Book(rs.getInt("isbn"),
